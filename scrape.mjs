...
const urls = [
  ...
  { url: `${DOMAIN}/estate-planning-elder-law-new-jersey/`, filename: 'estate-planning-elder-law-new-jersey.html' },
  ...
  { url: `${DOMAIN}/family-law/`, filename: 'family-law.html' },
  ...
  { url: `${DOMAIN}/municipal-court/`, filename: 'municipal-court.html' },
  ...
  { url: `${DOMAIN}/traffic-ticket-dui-lawyer-new-jersey/`, filename: 'traffic-ticket-dui-lawyer-new-jersey.html' },
